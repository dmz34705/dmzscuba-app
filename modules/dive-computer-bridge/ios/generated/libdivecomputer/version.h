...
/*
 * Hand-substituted from include/libdivecomputer/version.h.in for the vendored
 * libdivecomputer v0.9.0 (autotools would normally generate this). Keep the
 * values in sync with vendor/libdivecomputer/configure.ac if the submodule is
 * bumped.
 */
